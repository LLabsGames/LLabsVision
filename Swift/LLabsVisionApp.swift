//
//  LLabsVisionApp.swift
//  LLabsVision
//
//  Created by Kevin Watters on 27.12.2023.
    ...
    var body: some SwiftUI.Scene {
        ...
        WindowGroup(id: WindowGroupIds.MAIN) {
            ExampleScenesBrowser(debugName: WindowGroupIds.MAIN,
                ...
                .onAppear {
                    print("MAIN appear")
                    godotVision.setupRealityKitScene(rootEntityMain, volumeSize: VOLUME_SIZE, projectFileDir: pathToGodotProject)
                }
        }
        ...
        ImmersiveSpace(id: WindowGroupIds.IMMERSIVE) {
            ExampleScenesBrowser(debugName: WindowGroupIds.IMMERSIVE,
                ...
                .onAppear {
                    ...
                    godotVision.setupRealityKitScene(rootEntityImmersive, volumeSize: VOLUME_SIZE, projectFileDir: pathToGodotProject)
                }
                .onDisappear {
